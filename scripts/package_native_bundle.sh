...
cp "$ROOT/include/vev_sqlite.h" "$STAGE_DIR/$BUNDLE_ROOT/include/vev_sqlite.h"
...
cp "$ROOT/clients/c/sqlite_smoke.c" "$STAGE_DIR/$BUNDLE_ROOT/examples/sqlite.c"
cp "$ROOT/clients/c/sqlite_applications_smoke.c" \
  "$STAGE_DIR/$BUNDLE_ROOT/examples/sqlite-applications.c"
